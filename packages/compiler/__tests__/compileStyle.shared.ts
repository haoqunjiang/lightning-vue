// Adapted from the scoped-style coverage in vuejs/core
// packages/compiler-sfc/__tests__/compileStyle.spec.ts.
// Keep this file aligned with upstream fixes where the Lightning CSS path is
// expected to match the same public style-compiler contract.
